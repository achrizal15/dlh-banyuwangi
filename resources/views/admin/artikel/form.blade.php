...
<div class="card">
    <div class="card-body">
        <form action="{{$action=='create'?url($admin.'/'.$page):url($admin.'/'.$page.'/'.$article->id)}}" method="POST"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul"
                        placeholder="judul" value="@isset($article){{$article->judul}}@endisset" />
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control ckeditor @error('deskripsi') is-invalid @enderror" id="ckeditor"
                        name="deskripsi"
                        placeholder="Isi deskripsi">@isset($article){{$article->deskripsi}}@endisset</textarea>
            ...
            <input type="hidden" class="form-control @error('link') is-invalid @enderror" id="link" name="link"
                placeholder="link halaman" value="@isset($article){{$article->link}}@endisset" />
                
            <div class="row mb-3">
                <label for="gambar" class="col-sm-2 col-form-label">Gambar</label>
                <div class="col-sm-10">
                    <input type="file" class="dropify" id="gambar" name="gambar"  data-allowed-file-extensions="jpg png jpeg" data-default-file="@isset($article){{asset('storage/'.$article->gambar)}}@endisset"/>
