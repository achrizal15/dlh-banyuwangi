...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Galery
</h4>
<div class="card">
    ...
    <div class="card-body">
        ...
        <table class="table datatable" data-url="{{route('galerys.create')}}">
            <thead>
                <tr>
                    <th>Judul</th>
                    <th>tag</th>
                ...
                <tr>
                    ...
                    <td class="align-top">
                        ...
                        <a href="#" class="text-primary" data-bs-toggle="modal" data-bs-target="#basicModal"
                            id="ketGalery" data-deskripsi="{{$item->deskripsi}}">Read
                            More</a>
                    </td>
                    ...
                    <td class="align-top">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('galerys.edit',$item->id)}}"><i
                                        class="bx bx-edit-alt me-1"></i>
                                    Edit</a>
                                <form action="{{route('galerys.destroy',$item->id)}}" method="post">
                                    @csrf
                                    @method("DELETE")
