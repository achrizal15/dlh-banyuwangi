...
<div class="card">
    <div class="card-body">
        <form action="{{$action=='create'?url($admin.'/'.$page):url($admin.'/'.$page.'/'.$cerita_suksess->id)}}" method="POST"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul"
                        placeholder="judul" value="@isset($cerita_suksess){{$cerita_suksess->judul}}@endisset" />
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control ckeditor @error('deskripsi') is-invalid @enderror" id="ckeditor"
                        name="deskripsi"
                        placeholder="Isi deskripsi">@isset($cerita_suksess){{$cerita_suksess->deskripsi}}@endisset</textarea>
            ...
            <input type="hidden" class="form-control @error('link') is-invalid @enderror" id="link" name="link"
                placeholder="link halaman" value="@isset($cerita_suksess){{$cerita_suksess->link}}@endisset" />
                
            <div class="row mb-3">
                <label for="gambar" class="col-sm-2 col-form-label">Gambar</label>
                <div class="col-sm-10">
                    <input type="file" class="dropify" id="gambar" name="gambar"  data-allowed-file-extensions="jpg png jpeg" data-default-file="@isset($cerita_suksess){{asset('storage/'.$cerita_suksess->gambar)}}@endisset"/>
