...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Cerita Sukses
    </h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table datatable" data-url="{{ route('cerita-suksess.create') }}">
                    <thead>
                        <tr>
                            <th>Judul</th>
                            <th>tag</th>
                    ...
                    <tbody>
                        @foreach ($cerita_suksess as $item)
                            <tr>
                                ...
                                <td class="align-top">
                                    ...
                                    <a href="#" class="text-primary" data-bs-toggle="modal"
                                        data-bs-target="#basicModal" id="ketCerita"
                                        data-deskripsi="{{ $item->deskripsi }}">Read More</a>
                                </td>
                                <td class="align-top"><a target="_blank" href="{{ asset('/storage/' . $item->gambar) }}"><img
                                            src="{{ $item->gambar }}" alt="" width="50" height="50"></a></td>
                                ...
                                <td class="align-top">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('cerita-suksess.edit', $item->id) }}"><i
                                                    class="bx bx-edit-alt me-1"></i>
                                                Edit</a>
                                            <form action="{{ route('cerita-suksess.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
